...
/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/route/route.component.html":
/*!*********************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/route/route.component.html ***!
  \*********************************************************************************************/
/*! exports provided: default */
...
const routes = [
    ...
    {
        path: 'solicitude',
        loadChildren: () => Promise.all(/*! import() | pages-solicitude-solicitude-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-solicitude-solicitude-module")]).then(__webpack_require__.bind(null, /*! ./pages/solicitude/solicitude.module */ "./src/app/pages/solicitude/solicitude.module.ts")).then(m => m.SolicitudePageModule)
    },
    {
        path: 'solicitudelist',
        loadChildren: () => Promise.all(/*! import() | pages-solicitudelist-solicitudelist-module */[__webpack_require__.e("default~pages-activities-activities-module~pages-classified-classified-module~pages-companysol-compa~6e1b836b"), __webpack_require__.e("common"), __webpack_require__.e("pages-solicitudelist-solicitudelist-module")]).then(__webpack_require__.bind(null, /*! ./pages/solicitudelist/solicitudelist.module */ "./src/app/pages/solicitudelist/solicitudelist.module.ts")).then(m => m.SolicitudelistPageModule)
    },
    {
        path: 'companysol',
        loadChildren: () => Promise.all(/*! import() | pages-companysol-companysol-module */[__webpack_require__.e("default~pages-activities-activities-module~pages-classified-classified-module~pages-companysol-compa~6e1b836b"), __webpack_require__.e("common"), __webpack_require__.e("pages-companysol-companysol-module")]).then(__webpack_require__.bind(null, /*! ./pages/companysol/companysol.module */ "./src/app/pages/companysol/companysol.module.ts")).then(m => m.CompanysolPageModule)
    },
    {
        path: 'solicitude-detail',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-solicitude-detail-solicitude-detail-module */ "pages-solicitude-detail-solicitude-detail-module").then(__webpack_require__.bind(null, /*! ./pages/solicitude-detail/solicitude-detail.module */ "./src/app/pages/solicitude-detail/solicitude-detail.module.ts")).then(m => m.SolicitudeDetailPageModule)
    },
    {
        path: 'response',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-response-response-module */ "pages-response-response-module").then(__webpack_require__.bind(null, /*! ./pages/response/response.module */ "./src/app/pages/response/response.module.ts")).then(m => m.ResponsePageModule)
    },
    {
        path: 'response-detail',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-response-detail-response-detail-module */ "pages-response-detail-response-detail-module").then(__webpack_require__.bind(null, /*! ./pages/response-detail/response-detail.module */ "./src/app/pages/response-detail/response-detail.module.ts")).then(m => m.ResponseDetailPageModule)
    },
    {
        path: 'response-list',
        loadChildren: () => Promise.all(/*! import() | pages-response-list-response-list-module */[__webpack_require__.e("default~pages-activities-activities-module~pages-classified-classified-module~pages-companysol-compa~6e1b836b"), __webpack_require__.e("common"), __webpack_require__.e("pages-response-list-response-list-module")]).then(__webpack_require__.bind(null, /*! ./pages/response-list/response-list.module */ "./src/app/pages/response-list/response-list.module.ts")).then(m => m.ResponseListPageModule)
    },
    {
        path: 'company',
        loadChildren: () => Promise.all(/*! import() | pages-company-company-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-company-company-module")]).then(__webpack_require__.bind(null, /*! ./pages/company/company.module */ "./src/app/pages/company/company.module.ts")).then(m => m.CompanyPageModule)
    },
    {
        path: 'customer',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-customer-customer-module */ "pages-customer-customer-module").then(__webpack_require__.bind(null, /*! ./pages/customer/customer.module */ "./src/app/pages/customer/customer.module.ts")).then(m => m.CustomerPageModule)
    },
    {
        path: 'resetpass',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-resetpass-resetpass-module */ "pages-resetpass-resetpass-module").then(__webpack_require__.bind(null, /*! ./pages/resetpass/resetpass.module */ "./src/app/pages/resetpass/resetpass.module.ts")).then(m => m.ResetpassPageModule)
    },
    {
        path: 'about',
    ...
    {
        path: 'companyup',
        loadChildren: () => Promise.all(/*! import() | pages-companyup-companyup-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-companyup-companyup-module")]).then(__webpack_require__.bind(null, /*! ./pages/companyup/companyup.module */ "./src/app/pages/companyup/companyup.module.ts")).then(m => m.CompanyupPageModule)
    },
    {
        path: 'customerup',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-customerup-customerup-module */ "pages-customerup-customerup-module").then(__webpack_require__.bind(null, /*! ./pages/customerup/customerup.module */ "./src/app/pages/customerup/customerup.module.ts")).then(m => m.CustomerupPageModule)
    },
    {
        path: 'posts',
        loadChildren: () => Promise.all(/*! import() | pages-posts-posts-module */[__webpack_require__.e("default~pages-activities-activities-module~pages-classified-classified-module~pages-companysol-compa~6e1b836b"), __webpack_require__.e("common"), __webpack_require__.e("pages-posts-posts-module")]).then(__webpack_require__.bind(null, /*! ./pages/posts/posts.module */ "./src/app/pages/posts/posts.module.ts")).then(m => m.PostsPageModule)
    },
    {
        path: 'activities',
        loadChildren: () => Promise.all(/*! import() | pages-activities-activities-module */[__webpack_require__.e("default~pages-activities-activities-module~pages-classified-classified-module~pages-companysol-compa~6e1b836b"), __webpack_require__.e("pages-activities-activities-module")]).then(__webpack_require__.bind(null, /*! ./pages/activities/activities.module */ "./src/app/pages/activities/activities.module.ts")).then(m => m.ActivitiesPageModule)
    },
    {
        path: 'favors',
        loadChildren: () => Promise.all(/*! import() | pages-favors-favors-module */[__webpack_require__.e("default~pages-activities-activities-module~pages-classified-classified-module~pages-companysol-compa~6e1b836b"), __webpack_require__.e("pages-favors-favors-module")]).then(__webpack_require__.bind(null, /*! ./pages/favors/favors.module */ "./src/app/pages/favors/favors.module.ts")).then(m => m.FavorsPageModule)
    },
    {
        path: 'classified',
        loadChildren: () => Promise.all(/*! import() | pages-classified-classified-module */[__webpack_require__.e("default~pages-activities-activities-module~pages-classified-classified-module~pages-companysol-compa~6e1b836b"), __webpack_require__.e("pages-classified-classified-module")]).then(__webpack_require__.bind(null, /*! ./pages/classified/classified.module */ "./src/app/pages/classified/classified.module.ts")).then(m => m.ClassifiedPageModule)
    },
    {
        path: 'activityadd',
        loadChildren: () => Promise.all(/*! import() | pages-activityadd-activityadd-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-activityadd-activityadd-module")]).then(__webpack_require__.bind(null, /*! ./pages/activityadd/activityadd.module */ "./src/app/pages/activityadd/activityadd.module.ts")).then(m => m.ActivityaddPageModule)
    },
    {
        path: 'favoradd',
        loadChildren: () => Promise.all(/*! import() | pages-favoradd-favoradd-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-favoradd-favoradd-module")]).then(__webpack_require__.bind(null, /*! ./pages/favoradd/favoradd.module */ "./src/app/pages/favoradd/favoradd.module.ts")).then(m => m.FavoraddPageModule)
    },
    {
        path: 'classifiedadd',
        loadChildren: () => Promise.all(/*! import() | pages-classifiedadd-classifiedadd-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-classifiedadd-classifiedadd-module")]).then(__webpack_require__.bind(null, /*! ./pages/classifiedadd/classifiedadd.module */ "./src/app/pages/classifiedadd/classifiedadd.module.ts")).then(m => m.ClassifiedaddPageModule)
    },
    {
        path: 'postdetail',
        loadChildren: () => Promise.all(/*! import() | pages-postdetail-postdetail-module */[__webpack_require__.e("default~pages-activities-activities-module~pages-classified-classified-module~pages-companysol-compa~6e1b836b"), __webpack_require__.e("pages-postdetail-postdetail-module")]).then(__webpack_require__.bind(null, /*! ./pages/postdetail/postdetail.module */ "./src/app/pages/postdetail/postdetail.module.ts")).then(m => m.PostdetailPageModule)
    },
    {
        path: 'resetpassup',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-resetpassup-resetpassup-module */ "pages-resetpassup-resetpassup-module").then(__webpack_require__.bind(null, /*! ./pages/resetpassup/resetpassup.module */ "./src/app/pages/resetpassup/resetpassup.module.ts")).then(m => m.ResetpassupPageModule)
    },
    {
        path: 'inicio',
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() | pages-search-category-search-category-module */ "pages-search-category-search-category-module").then(__webpack_require__.bind(null, /*! ./pages/search-category/search-category.module */ "./src/app/pages/search-category/search-category.module.ts")).then(m => m.SearchCategoryPageModule)
    },
    {
        path: 'search-city',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-search-city-search-city-module */ "pages-search-city-search-city-module").then(__webpack_require__.bind(null, /*! ./pages/search-city/search-city.module */ "./src/app/pages/search-city/search-city.module.ts")).then(m => m.SearchCityPageModule)
    },
    {
        path: 'search-category-esp',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-search-category-esp-search-category-esp-module */ "pages-search-category-esp-search-category-esp-module").then(__webpack_require__.bind(null, /*! ./pages/search-category-esp/search-category-esp.module */ "./src/app/pages/search-category-esp/search-category-esp.module.ts")).then(m => m.SearchCategoryEspPageModule)
    },
    {
        path: 'categories',
    ...
    {
        path: 'promotions',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-promotions-promotions-module */ "pages-promotions-promotions-module").then(__webpack_require__.bind(null, /*! ./pages/promotions/promotions.module */ "./src/app/pages/promotions/promotions.module.ts")).then(m => m.PromotionsPageModule)
    },
    {
        path: 'remates',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-remates-remates-module */ "pages-remates-remates-module").then(__webpack_require__.bind(null, /*! ./pages/remates/remates.module */ "./src/app/pages/remates/remates.module.ts")).then(m => m.RematesPageModule)
    },
    {
        path: 'special',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-special-special-module */ "pages-special-special-module").then(__webpack_require__.bind(null, /*! ./pages/special/special.module */ "./src/app/pages/special/special.module.ts")).then(m => m.SpecialPageModule)
    },
    {
        path: 'advertisements',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-advertisements-advertisements-module */ "pages-advertisements-advertisements-module").then(__webpack_require__.bind(null, /*! ./pages/advertisements/advertisements.module */ "./src/app/pages/advertisements/advertisements.module.ts")).then(m => m.AdvertisementsPageModule)
    },
    {
        path: 'weekend',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-weekend-weekend-module */ "pages-weekend-weekend-module").then(__webpack_require__.bind(null, /*! ./pages/weekend/weekend.module */ "./src/app/pages/weekend/weekend.module.ts")).then(m => m.WeekendPageModule)
    }
];
...
/* harmony import */ var _services_busy_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./services/busy.service */ "./src/app/services/busy.service.ts");
...
let AppComponent = class AppComponent {
    constructor(menuController, platform, splashScreen, statusBar, firebaseX, router, busyService) {
    ...
    info() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.busyService.presentAlert("¡Aviso!", "¡Acción Proximamente Disponible!");
        });
    }
    sol() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
    ...
    promociones() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.busyService.presentAlert("¡Aviso!", "¡Acción Promocion Proximamente Disponible!");
            this.router.navigate(['/promotions']);
        });
    }
    Remates() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.busyService.presentAlert("¡Aviso!", "¡Acción Remates Proximamente Disponible!");
            this.router.navigate(['/remates']);
        });
    }
    Fechas_Especiales() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.busyService.presentAlert("¡Aviso!", "¡Acción Fechas Especiales Proximamente Disponible!");
            this.router.navigate(['/special']);
        });
    }
    Anuncios() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.busyService.presentAlert("¡Aviso!", "¡Acción Anuncios Proximamente Disponible!");
            this.router.navigate(['/advertisements']);
        });
    }
    Fin_Semana() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.busyService.presentAlert("¡Aviso!", "¡Acción Fin De Semana Proximamente Disponible!");
...
/* harmony import */ var _services_busy_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./services/busy.service */ "./src/app/services/busy.service.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _HammerGestureConfig__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./HammerGestureConfig */ "./src/app/HammerGestureConfig.ts");
...
/* harmony import */ var ionic4_auto_complete__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ionic4-auto-complete */ "./node_modules/ionic4-auto-complete/fesm2015/ionic4-auto-complete.js");
/* harmony import */ var _components_map_map_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./components/map/map.component */ "./src/app/components/map/map.component.ts");
...
/* harmony import */ var _components_route_route_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./components/route/route.component */ "./src/app/components/route/route.component.ts");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        providers: [
            ...
            //FCM,
            _services_busy_service__WEBPACK_IMPORTED_MODULE_12__["BusyService"],
            _services_api_service__WEBPACK_IMPORTED_MODULE_10__["ApiService"],
            _services_authguard_service__WEBPACK_IMPORTED_MODULE_9__["AuthguardService"],
            _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_6__["StatusBar"],
            _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_5__["SplashScreen"],
            { provide: _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouteReuseStrategy"], useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicRouteStrategy"] },
            { provide: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["HAMMER_GESTURE_CONFIG"], useClass: _HammerGestureConfig__WEBPACK_IMPORTED_MODULE_14__["IonicGestureConfig"] }
        ],
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _services_busy_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/busy.service */ "./src/app/services/busy.service.ts");
...
let MapComponent = class MapComponent {
    constructor(nativeGeocoder, busyService, platform, geolocation, modalCtrl) {
    ...
    ngOnInit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.platform.ready().then(() => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                ...
                let load = yield this.busyService.presentProAlert();
                load.present();
    ...
    autocmplete() {
        ...
        autocompleted.setFields(['address_components', 'geometry', 'icon', 'name']);
...
Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('googleplaces', { static: true })
...
MapComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./map.component.scss */ "./src/app/components/map/map.component.scss")).default]
    })
], MapComponent);
...
/***/ "./src/app/components/route/route.component.scss":
/*!*******************************************************!*\
  !*** ./src/app/components/route/route.component.scss ***!
  \*******************************************************/
/*! exports provided: default */
...
let RouteComponent = class RouteComponent {
    ...
    startNavigating2(origin, destination) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            let load = yield this.busyService.presentProAlert();
            load.present();
            ...
            }, (res, status) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                load.dismiss();
...
RouteComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-route',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./route.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/components/route/route.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./route.component.scss */ "./src/app/components/route/route.component.scss")).default]
    })
], RouteComponent);
...
let ApiService = class ApiService {
    ...
    Post(data, url) {
        let headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json; charset=utf-8');
        let options = {
            headers: headers
        };
        return new Promise((resolve, reject) => {
            this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiurl + url, data, options)
    ...
    Put(data, url) {
        ...
        return new Promise((resolve, reject) => {
            this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiurl + url, data, options)
                .subscribe(res => {
                resolve(res);
            }, (err) => {
                reject(err);
    ...
    upload(url, formData) {
        ...
        const req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpRequest"]('POST', _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiurl + url, formData, options);
        return this.http.request(req);
    }
    Delete(url) {
        return new Promise((resolve, reject) => {
            this.http.delete(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiurl + url)
                .subscribe(res => {
                resolve(res);
            }, (err) => {
                reject(err);
    ...
    Get(url) {
        return new Promise((resolve, reject) => {
            this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiurl + url)
                .subscribe(res => {
                resolve(res);
            }, (err) => {
                reject(err);
...
let BusyService = class BusyService {
    constructor(actionSheetController, alertCtrl, loading) {
    ...
    presentAlertYesNo(title, message) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return new Promise((resolve) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                const alert = yield this.alertCtrl.create({
                    header: title,
...
module.exports = __webpack_require__(/*! C:\Users\Ivancho\Documents\PRY_QPRICE\QPRICE\src\main.ts */"./src/main.ts");
