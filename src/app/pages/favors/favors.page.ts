...
@Component({
  selector: 'app-favors',
  templateUrl: './favors.page.html',
  styleUrls: ['./favors.page.scss'],
})
export class FavorsPage implements  OnInit {
  ...
  ionViewWillEnter(){
   ...
   activities(){
    ...
    this.apiService.Get("Posts/PostsByType/F/" +provinceId ).then(async res=>{
      this.working=false;
      this.items=res;
