...
@Component({
  ...
  templateUrl: './activityadd.page.html',
  styleUrls: ['./activityadd.page.scss'],
})
  ...
  tocurrency()
{
 ...
 async pickfile1(){
  ...
  async send(){
    ...
    {
      await this.busyService.presentAlert("¡Información!","Adjunte una imágen, también puede  agregar una descripción");
     return;
    }
